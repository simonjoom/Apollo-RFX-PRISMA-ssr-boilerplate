...
module.exports.pitch = function(request) {
  ...
  if (this[NS] === undefined) {
    ...
    childCompiler.hooks.compilation.tap(plugin, function(compilation) {
    ...
    childCompiler.hooks.thisCompilation.tap(plugin, function(compilation) {
    ...
    var source;
    childCompiler.hooks.afterCompile.tapAsync(plugin, function(compilation, callback) {
...
if (module.hot) {
 module.hot.accept();
	if (module.hot.data) {
		...
		var cssReload = require(${loaderUtils.stringifyRequest(this, '!' + path.join(__dirname, "hotModuleReplacement2.js"))})("${publicPath}%%extracted-file%%",{fileMap: '../../page/{fileName}'})
